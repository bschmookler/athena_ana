  ...
  StatusCode execute() override {
    ...
    for (const auto& p : mcparts) {
      if (p.genStatus() == 4 && p.pdgID() == 11) {
        ...
        ei.t = sqrt( ei.z*ei.z + 0.000511*0.000511 );
      ...
      if (p.genStatus() == 4 && p.pdgID() == 2212) {
        ...
        if( fabs(pi.z - 41.0) < 5.0 ){
          pi.x = -41.0*sin(25./1000.);
          pi.z = 41.0*cos(25./1000.);
        }
        else if( fabs(pi.z - 100.0) < 5.0 ){
          pi.x = -100.0*sin(25./1000.);
          pi.z = 100.0*cos(25./1000.);
        }
        else if( fabs(pi.z - 275.0) < 5.0 ){
          pi.x = -275.0*sin(25./1000.);
          pi.z = 275.0*cos(25./1000.);
        }
